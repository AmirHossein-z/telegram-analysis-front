...
const CardDesktop = (props: ICardProps): JSX.Element => {
  ...
  return (
    <Link to={`${path}${id}`}>
      <section className="card cursor-pointer bg-base-100 text-base-content shadow-bg transition-all duration-300 ease-linear hover:-translate-y-2 hover:bg-base-200">
